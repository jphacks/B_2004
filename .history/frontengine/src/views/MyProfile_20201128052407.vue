  ...
  methods: {
    ...
    getResult: function () {
      return firebase
        ...
        .then((snapshot) => {
          const output = {}
          console.log("kfoekofAAAAAAAA", snapshot[0].data())
          output.rating = snapshot[0].data().rating
          output.ratingDiviation = snapshot[0].data().ratingDiviation
          output.time = snapshot[0].data().time
