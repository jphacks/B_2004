...
export default {
  ...
  methods: {
    ...
    culcRateUser: function () {
      ...
      syoritu = 1 / (1 + 10 ** (seidoProblem * (updateProblemRate.r - updateUserRate.r)))
      ...
      console.log("miruUser", this.userNewRating.r, syoritu)
      /* firebase
              .firestore()
              .collection("users")
    ...
    culcRateProblem: function () {
      ...
      seido = 1 / Math.sqrt(1 + (3 / (Math.PI ** 2) * keisu * updateUserRate.RD ** 2))
      seidoProblem = 1 / Math.sqrt(1 + (3 / (Math.PI ** 2) * keisu * updateProblemRate.RD ** 2))
      syoritu = 1 / (1 + 10 ** (seido * (updateUserRate.r - updateProblemRate.r)))
      ...
      console.log("miru", updateUserRate, updateProblemRate, syoritu, seido, s)
